...
$SetupPath = "C:\scripts\WindowsSandboxTools\wsbScripts"
...
#using splatting to pass this parameter. Using PSDefaultParameterValues failed for some reason.cod
...
Start-Job -name "Module-Install" -ScriptBlock { Install-Module PSScriptTools, PSTeachingTools, BurntToast -Force ; log "PowerShell modules installed" } @jobparams
