Function Start-WindowsSandbox {
    ...
    if ($NoSetup) {
        ...
        if ($Configuration -match "WinSandBx|presentation") {
            ...
            #you can specify parameters for RegisterWatcher or modify the
    ...
    Write-Host "Windows Sandbox has been launched. You may need to wait for any configurations to complete." -foregroundColor green
}
